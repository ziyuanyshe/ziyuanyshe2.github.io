...
<meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1" /> <meta name="renderer" content="webkit"/><!--  使用最新的引擎渲染网页 -->
...
<?php echo base64_decode($CONFIG["HEADER"]) ?>
...
<?php if($CONFIG["templets"]['off']==1):?><style type="text/css"><?php  echo $CONFIG["templets"]['css']?></style><?php endif ?>
</head>
<body>
<?php echo base64_decode($CONFIG["HEADER_CODE"]) ?>
<div class="fixed"></div>   
<div class="header">
<div class="nav">	
	<i id="logo" class="logo"></i>	 
    <i id="list" class="list"> </i>	
<?php if($CONFIG["BOOK_INFO"]['off']==1):?>
<button class="btns-hamburger" onclick="xyplay.online()">	
<div class="AD_AD">
<marquee scrollamount=3><?php echo base64_decode($CONFIG["BOOK_INFO"]['info']);?></marquee>
</div>
</button>
<?php endif ?>
